// ======================================================================
// BaseCheck — layout fisik cek yang dipakai bersama oleh semua bank.
// Setiap komponen bank (MandiriCheck, BCACheck, dst) tinggal mengoper
// `template` (warna, ukuran, label, posisi tanda tangan) miliknya sendiri.
// ======================================================================
export default function BaseCheck({ template, form }) {
    return (
        <div
