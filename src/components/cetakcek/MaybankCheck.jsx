...
// Jarak antar garis (masing-masing beda sesuai spek)
const LINE1_TO_LINE2_GAP_CM = 0.9; // garis tanggal -> garis kedua
const LINE2_TO_LINE3_GAP_CM = 0.6; // garis kedua -> garis ketiga
const LINE3_TO_LINE4_GAP_CM = 0.65; // garis ketiga -> garis keempat

const LINE2_TOP_CM = LINE_TANGGAL_TOP_CM + LINE1_TO_LINE2_GAP_CM; // 2.4
const LINE3_TOP_CM = LINE2_TOP_CM + LINE2_TO_LINE3_GAP_CM; // 3.0
...
// ===== Panjang garis =====
const LINE23_WIDTH_CM = 16.2;
const LINE4_WIDTH_CM = 11.2;

// ===== Kotak nominal =====
const KOTAK_NOMINAL_WIDTH_CM = 4.4;
...
const LABEL_ATAU_PEMBAWA_WIDTH_CM = 1.9;
        ...
        >
            ...
            >
                <text
                    ...
                    fill="#9ca3af"
                >
                    On presentation of this cheque pay
                </text>
            </svg>
            ...
            {/* ===== Kotak nominal (panjang 4.4cm, lebar 0.5cm) ===== */}
            <div
