        ...
        <div className="flex flex-nowrap justify-between items-end gap-2">
          ...
          <div className="flex flex-nowrap items-end gap-2">
            ...
            <div className="inline-flex bg-gray-100 border border-gray-200 rounded-lg p-1 shrink-0">
              <button
                type="button"
                onClick={() => setLokasi("Rungkut")}
                className={`rounded-md font-medium transition whitespace-nowrap text-sm ${lokasi === "Rungkut"
              ...
              <button
                type="button"
                onClick={() => setLokasi("Perak")}
                className={`rounded-md font-medium transition whitespace-nowrap text-sm ${lokasi === "Perak"
                  ? "bg-gray-600 text-white shadow-sm"
                  : "text-gray-600 hover:bg-gray-200"
                  }`}
